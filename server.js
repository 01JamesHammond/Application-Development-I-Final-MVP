...
app.post("/api/devices", async (req, res) => {
    try {
        ...
        const newDevice = await Device.create({ name, type, serialNumber, status, location, purchaseDate, notes });
...
app.delete("/api/devices/:id", async (req, res) => {
    try {
        const deletedRowsCount = await Device.destroy({ where: { id: req.params.id } });
...
app.post("/api/users", async (req, res) => {
    try {
        ...
        const newUser = await User.create({ name, email, department, role });
...
app.post("/api/assignments", async (req, res) => {
    try {
        ...
        const newAssignment = await Assignment.create({ deviceId, userId, assignedAt, returnedAt });
...
app.delete("/api/assignments/:id", async (req, res) => {
    try {
        const deletedRowsCount = await Assignment.destroy({ where: { id: req.params.id } });
